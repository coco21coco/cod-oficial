...
@Autonomous(name = "Albastru Close Colt")
public class AlbastruCloseColt extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if(opModeIsActive() && !isStopRequested()){
            ...
            for (Recognition TSE : currentRecognition) {
                ...
                if (TSE.getLeft() < 200) {
                    ...
                    TrajectorySequence traiect = drive.trajectorySequenceBuilder(new Pose2d(13, 60, Math.toRadians(270)))
                            .lineToLinearHeading(new Pose2d(15, 38, Math.toRadians(230)))
                    ...
                    TrajectorySequence panou = drive.trajectorySequenceBuilder(new Pose2d(45, 30, Math.toRadians(180)))
                            .strafeRight(18)
                            .back(10)
                            .build();
                ...
                if (TSE.getLeft() >= 200) {
                    ...
                    TrajectorySequence panou = drive.trajectorySequenceBuilder(new Pose2d(45, 43, Math.toRadians(180)))
                            .strafeRight(18)
                            .back(6)
                            .build();
            ...
            if (currentRecognition.size() == 0) {
                ...
                TrajectorySequence traiect = drive.trajectorySequenceBuilder(new Pose2d(13, 60, Math.toRadians(270)))
                        .lineToSplineHeading(new Pose2d(13, 60, Math.toRadians(270)))
                        .lineToSplineHeading(new Pose2d(11, 36, Math.toRadians(230)))
                        .addTemporalMarker(()-> robot.colectare.setPower(1))
                        .waitSeconds(1)
